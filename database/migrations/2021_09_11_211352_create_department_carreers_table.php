...
class CreateDepartmentCarreersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('department_carreers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('department_carreers');
    }
}
