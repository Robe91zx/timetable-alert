...
class CreateCollegeHasCarreersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('college_has_carreers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('college_has_carreers');
    }
}
