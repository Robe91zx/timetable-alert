...
class CreateFacultyHasCarreersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('faculty_has_carreers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('faculty_has_carreers');
    }
}
