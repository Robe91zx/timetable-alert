    ...
    >
      ...
      >
        <div
          ...
          "
        >
          <jet-title> Registro de Relacion Asignatura - Cursos</jet-title>
        ...
        >
          ...
          <jet-button @click="registerMasive()" :disabled="form.processing">
            Guardar</jet-button
          >
        </div>
      </div>
...
export default defineComponent({
  ...
  methods: {
    close: function () {
      this.$parent.$parent.closeExcelSubjectHasCourses();
    },
    registerMasive: function () {
      Inertia.post(route("subjectsandcourses.import"), {
        _method: "get",
        file: this.form.file,
      });
      this.$parent.$parent.closeExcelSubjectHasCourses();
