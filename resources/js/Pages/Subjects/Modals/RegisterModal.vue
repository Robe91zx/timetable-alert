    ...
    >
      ...
      >
              ...
              >
                <div class="md:col-span-5">
                  ...
                  >
                    <option value="" disabled>
                      ¿A que malla pertenece la asignatura?
                    </option>
                    <option
                ...
                <div class="md:col-span-5">
                  ...
                  >
                    ...
                    <option v-for="hours in 13" :key="hours" :value="hours - 1">
                      {{ hours - 1 }}
                    </option>
                  </select>
        ...
        >
          ...
          <jet-button @click="registerSubject()" :disabled="form.processing">
            Guardar</jet-button
          >
        </div>
      </div>
...
export default defineComponent({
  ...
  methods: {
    close: function () {
      this.$parent.$parent.closeRegisterSubject();
    },
    registerSubject: function () {
      this.form.post(route("subjects.store"), {
