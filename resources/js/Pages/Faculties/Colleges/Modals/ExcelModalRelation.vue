...
export default defineComponent({
  ...
  methods: {
    close: function(){ this.$parent.$parent.closeExcelFacultyHasColleges()},
    registerMasive: function(){ Inertia.post(route('facultiesandcolleges.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeExcelFacultyHasColleges()} ,
  }
})
</script>