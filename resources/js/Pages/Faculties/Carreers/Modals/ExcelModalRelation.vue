...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            registerMasive: function(){ Inertia.post(route('facultiesandcarreers.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeModalExcelRelationCarreer()} ,
        }
    })
</script>
