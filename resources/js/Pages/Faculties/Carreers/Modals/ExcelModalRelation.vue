...
<div class="flex flex-col w-full mx-auto rounded-lg border border-gray-300 shadow-xl">
  <div class="flex flex-row justify-between p-6 bg-white border-b border-gray-200 rounded-tl-lg rounded-tr-lg">
    <jet-title> Registro de Relacion Facultad - Carreras</jet-title>
...
export default defineComponent({
  ...
  methods: {
    close: function(){ this.$parent.$parent.closeExcelFacultyHasCarreers()},
    registerMasive: function(){ Inertia.post(route('facultiesandcarreers.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeExcelFacultyHasCarreers()} ,
  }
