    ...
    >
      ...
      >
          ...
          <form @submit.prevent="submit">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              ...
              <div class="md:col-span-5">
                <jet-form-title>Email</jet-form-title
                ><jet-form-input v-model="form.email" />
                <div class="italic" if="form.errors.email">
                  {{ form.errors.email }}
                </div>
              </div>
              <div class="md:col-span-5">
                <jet-form-title>Fono:</jet-form-title
                ><jet-form-input v-model="form.phone" />
                <div class="italic" if="form.errors.phone">
                  {{ form.errors.phone }}
                </div>
              </div>
              <div class="md:col-span-5">
                <jet-form-title>Website</jet-form-title
                ><jet-form-input v-model="form.website" />
                <div class="italic" if="form.errors.website">
                  {{ form.errors.website }}
                </div>
              </div>
            </div>
        ...
        >
          ...
          <jet-button @click="registerFaculty()" :disabled="form.processing">
            Guardar</jet-button
          >
        </div>
      </div>
...
export default defineComponent({
  ...
  methods: {
    close: function () {
      this.$parent.$parent.closeRegisterFaculty();
    },
    registerFaculty: function () {
      this.form.post(route("faculties.store"), {
