...
<script>
  ...
  methods: {
    close: function(){ this.$parent.$parent.closeExcelRegister()},
    registerMasive: function(){ Inertia.post(route('faculties.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeExcelRegister()} ,
  }
})
</script>
