...
<div class="flex flex-col w-full mx-auto rounded-lg border border-gray-300 shadow-xl">
  <div class="flex flex-row justify-between p-6 bg-white border-b border-gray-200 rounded-tl-lg rounded-tr-lg">
    <jet-title> Registro de Relacion Facultad - Departamento</jet-title>
...
export default defineComponent({
  ...
  components: { Modal, JetTitle, JetButton, ExitIcon, UploadIcon },

  props: { show: { default: false}, maxWidth: { default: '2xl'}, closeable: { default: true} },

  methods: {
    close: function(){ this.$parent.$parent.closeExcelFacultyHasDepartments()},
    registerMasive: function(){ Inertia.post(route('facultiesanddepartments.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeExcelFacultyHasDepartments()} ,
  }
})
</script>
