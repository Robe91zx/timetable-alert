...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            close: function(){ this.$parent.$parent.closeModalExcelRelationDepartment()},
            registerMasive: function(){ Inertia.post(route('facultiesanddepartments.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeModalExcelRelationDepartment()} ,
        }
    })
</script>
