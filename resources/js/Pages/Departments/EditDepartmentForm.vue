  ...
  <app-layout title="Departamentos">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
        Modificar Datos: Departamento de {{ department.name }}
      </h2>
    </template>
              ...
              <div class="lg:col-span-2">
                ...
                >
                  ...
                  <div class="md:col-span-3">
                    ...
                    ><jet-input v-model="form.website" />
                ...
                <div class="inline-flex items-end py-8">
                  ...
                  <p class="font-semibold text-gray-600 cursor-pointer">
                    <Link :href="route('departments.index')"> Regresar</Link>
                  </p>
                </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      form: useForm({
        ...
        vcode: this.$props.department.vcode,
        code: this.$props.department.code,
        email: this.$props.department.email,
        phone: this.$props.department.phone,
        website: this.$props.department.website,
      }),
    };
  },
  ...
  methods: {
    submit() {
      this.form.put(route("departments.update", this.$props.department));
    },
  },
};
</script>