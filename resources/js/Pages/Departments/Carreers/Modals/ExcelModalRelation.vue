...
export default defineComponent({
  ...
  methods: {
    close: function(){ this.$parent.$parent.closeExcelDepartmentHasCarreers()},
    registerMasive: function(){ Inertia.post(route('departmentsandcarreers.import'), { _method: 'get', file: this.form.file });this.$parent.$parent.closeExcelDepartmentHasCarreers()} ,
  }
})
</script>
