    ...
    >
      ...
      >
        <div
          ...
          "
        >
          <jet-title> Registro de Relacion Mallas - Asignaturas</jet-title>
...
export default defineComponent({
  ...
  methods: {
    close: function () {
      this.$parent.$parent.closeExcelCurriculumHasSubjects();
    },
    registerMasive: function () {
      Inertia.post(route("curriculumsandsubjects.import"), {
        _method: "get",
        file: this.form.file,
      });
      this.$parent.$parent.closeExcelCurriculumHasSubjects();
