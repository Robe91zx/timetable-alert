              ...
              <div class="lg:col-span-2">
                ...
                >
                  <div class="md:col-span-5">
                    <jet-label>Codigo</jet-label
                    ><jet-input v-model="form.code" />
                  ...
                  <div class="md:col-span-5">
                    <jet-label>Descripcion</jet-label
                    ><jet-input v-model="form.description" />
                  ...
                  <div class="md:col-span-5">
                    ...
                    <div class="italic" if="form.errors.carreer_vcode">
                      {{ form.errors.carreer_vcode }}
                    </div>
                  </div>
                  <div class="md:col-span-5">
                  ...
                  <div class="inline-flex items-end py-8">
                    ...
                    <p class="font-semibold text-gray-600 cursor-pointer">
                      <Link :href="route('curriculums.index')"> Regresar</Link>
                    </p>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted() {
    axios.get(route("carreers.getCarreers")).then((response) => {
  ...
  data() {
    return {
      form: useForm({
        code: this.$props.curriculum.code,
        name: this.$props.curriculum.name,
        description: this.$props.curriculum.description,
        duration: this.$props.curriculum.duration,
        carreer_vcode: this.$props.curriculum.carreer_vcode,
  ...
  methods: {
    submit() {
      this.form.put(route("curriculums.update", this.$props.curriculum));
    },
  },
};
</script>