...
<div class="flex flex-col w-full mx-auto rounded-lg border border-gray-300 shadow-xl">
  ...
  <div class="flex flex-row items-center justify-between p-5 bg-white border-t border-gray-200 rounded-bl-lg rounded-br-lg">
    <p class="font-semibold text-gray-600" @click="close()" :disabled="form.processing">  Regresar</p>
    <jet-button @click="registerCollege()"> Guardar</jet-button>
  </div>
</div>
</div>
...
export default defineComponent({
  ...
  methods: {
    close: function(){this.$parent.$parent.closeRegisterCollege()},
    registerCollege: function(){ this.form.post(route('colleges.store'), {
