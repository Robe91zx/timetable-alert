...
<app-layout title="Carreras">
  <template #header> 
    <div v-for="college in CarreersOf" v-bind:key="college.id">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Escuela de {{college.name}}</h2>
    </div>  
  </template>   
  ...
  <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
    <table class="min-w-full divide-y divide-gray-200">
      ...
      <tbody class="bg-white divide-y divide-gray-200">     
        <template v-for="college in CarreersOf" v-bind:key="college.id">   
          <tr v-for="carreer in college.carreers" :key="carreer.id"> 
...
export default {
  props:{ CarreersOf:Array, columns:Array, selectedDepartment: Object},
