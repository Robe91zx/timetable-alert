<template>
    <app-layout>
        <template #header>
            <h2>--NO ESTA CONFIGURADO EL FORMULARIO--Crear Ayudantia</h2>
        </template>    
                    ...
                    <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                            <div class="text-gray-600">
                                <p class="font-medium text-lg">Detalle de Ayudantia</p>
...
export default {
    ...
    methods:{
        submit(){
            this.$inertia.post(route('workshops.store'),this.form);
        }
    }
}
</script>