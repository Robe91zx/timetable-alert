                                    ...
                                    <div class="ml-3 relative">
                                        <jet-dropdown align="right" width="60" >   
                                            ...
                                            <template #content > 
                                                ...
                                                <jet-dropdown-link :href="route('subjects.index')" :active="route().current('subjects.index')">
                                                Asignaturas
                                                </jet-dropdown-link>
                                                <jet-dropdown-link class="cursor-pointer" :href="route('courses.index')" :active="route().current('courses.index')">
                                                Cursos
                                                </jet-dropdown-link>
                                                <jet-dropdown-link :href="route('workshops.index')" :active="route().current('workshops.index')">
                                                Ayudantias
                                                </jet-dropdown-link>
                                            </template>
                                        </jet-dropdown>  
